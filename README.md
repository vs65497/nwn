...
### **Discussion** ([_read more_](https://github.com/vs65497/nwn?tab=readme-ov-file#4-discussion))
  ...
  * The output conductance rises due to an input PWM and remains elevated after disabling the input signal, suggesting formation and retention of conductive paths.

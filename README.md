...
* Begin with simplified models but explicitly validate them against the physical constraints of atomic switching.
* Establish test cases using known inputs (e.g., square pulses) and compare responses across different topologies.
* Consider sensitivity analyses to understand how topology, pulse duration, and inter-pulse intervals affect memory and signal propagation.

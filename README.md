...
Following this thinking into practice, we find physical implementations of neural networks. In this study, I explore how Kuncic et. al. simulate an atomic switch network. Each junction between silver-sulfide (Ag2S) nanowires act as a memristor (resistance-modulated gate) which "mimics the chemical synapse between neurons in response to electrical stimuli." Junctions ("neurodes") form and annihilate bridges between pairs of nanowires via reduction and oxidation reactions, respectively, when a voltage difference is applied. "[W]hen connected together in a self-organized manner, similar to a neuronal network, atomic switch networks exhibit emergent brain-like complexity properties, including nonlinear stochastic dynamics and memorization, making them a unique experimental system for emulating intelligence." (_Kuncic 2018_)
